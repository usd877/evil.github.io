...
- 🛠️ [**Простой Python-скрипт для автоматического сканирования уязвимостей веб-приложений с использованием OWASP ZAP API**](https://github.com/usd877/Web-Vulnerability-Scanner-using-ZAP-API)
